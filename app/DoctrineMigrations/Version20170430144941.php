 ...
 */
class Version20170430144941 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product ADD category_id INT DEFAULT NULL, ADD published TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product DROP category_id, DROP published');
    }
}
