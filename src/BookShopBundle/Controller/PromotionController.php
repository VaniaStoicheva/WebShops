...
class PromotionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $promotions = $em->getRepository('BookShopBundle:Promotion')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BookShopBundle\Form\PromotionType', $promotion);
    ...
    {
        $deleteForm = $this->createDeleteForm($promotion);
        $editForm = $this->createForm('BookShopBundle\Form\PromotionType', $promotion);
